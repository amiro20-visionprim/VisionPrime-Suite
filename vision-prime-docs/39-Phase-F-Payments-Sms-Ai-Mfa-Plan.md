...
## قدم بعدی — فاز G (اجرا شد — سند ۴۰)

- ✅ اتصال SMS به DunningJob و یادآوری انتشار (پیامک به شمارهٔ org)
- ✅ کد پشتیبان MFA: مودال نمایش یک‌بارمصرف بعد از فعال‌سازی
- ✅ گزارش هفتگی مالک (جمعه) + MFA اختیاری با کلید مرکزی + رفع منوی موبایل پلتفرم

باقی‌مانده برای آینده:

- کلیدهای واقعی درگاه‌ها (env) + تست پرداخت واقعی
- MFA برای همهٔ نقش‌های حساس (نه فقط سوپرادمین) با زیرساخت اختیاری سند ۴۰
