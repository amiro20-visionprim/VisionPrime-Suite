...
class ContentQualityGuardTest extends TestCase
{
    ...
    public function test_quality_guard_passes_valid_tutorial_article(): void
    {
        ...
        $body = '<h2>مقدمه</h2><p>'.$paragraph.'</p>'
            .'<h2>مراحل نصب</h2><p>'.str_repeat($paragraph, 12).'</p>'
            .'<h2>تنظیمات اولیه</h2><p>'.str_repeat($paragraph, 12).'</p>'
            .'<h2>نتیجه‌گیری</h2><p>پس از نصب، سایت شما آماده است. برای خرید هاست با ما تماس بگیرید. '.$paragraph.'</p>';
