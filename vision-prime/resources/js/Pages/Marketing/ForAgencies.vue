...
const workflow: AudienceStep[] = [
  { title: 'اتصال', text: 'پلاگین Vision Prime روی وردپرس مشتری نصب و با HMAC امضا می‌شود؛ سرچ کنسول هم متصل می‌شود.' },
...
const faqs: Faq[] = [
  {
    q: 'آیا Vision Prime جایگزین تیم SEO ماست؟',
  ...
  },
  {
    ...
    a: 'کاملاً به نام برند آژانس. در پلن آژانس، پرتال و گزارش‌ها وایتدلیبل هستند — مشتری شما هیچ‌جا نام Vision Prime را نمی‌بیند مگر اینکه خودتان بخواهید.',
  },
  {
  ...
  <MarketingLayout>
    <main>
      <AudiencePageHero
        ...
        description="Vision Prime دادهٔ همهٔ مشتریان شما را به فرصت‌های رتبه‌بندی‌شده، تغییرات کنترل‌شده و گزارش‌های وایتدلیبل تبدیل می‌کند — بدون وابستگی به ابزارهای پراکنده و گزارش‌های دستی."
        :stats="[
      ...
      <AudienceWhySection
        ...
        title="سه دلیلی که آژانس‌ها با Vision Prime مقیاس می‌گیرند."
        :items="why"
      />
